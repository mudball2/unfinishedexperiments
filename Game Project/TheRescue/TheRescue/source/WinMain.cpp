...
const TCHAR*	g_szWINDOW_CLASS_NAME	= _T("SGDTheRescue");			    //	Window Class Name.
const TCHAR*	g_szWINDOW_TITLE		= _T("The Rescue");		        //	Window Title.
...
//	Function:	MakeWindow
//	
//	Purpose:	Creates and sizes the window appropriately depending
//				on if the application is windowed or full screen.
//
/////////////////////////////////////////
HWND MakeWindow(HINSTANCE hInstance)
{
	...
	return CreateWindowEx(WS_EX_APPWINDOW,											//	Extended Style flags.
						  ...
						  dwWindowStyleFlags ^ WS_MAXIMIZEBOX ^ WS_THICKFRAME,										//	Window Style Flags.
